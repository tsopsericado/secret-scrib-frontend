...
const RedirectPopup = ({ visible, onClose }: Props) => {
  ...
  return (
    <div
      ...
      className="fixed  z-30 inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center"
    >
      <div className="relative w-[500px] h-[35vh] bg-white p-5 rounded">
        <h1 className="text-[22px] text-gray-500">Disconnect ?</h1>
        <div>
          <p className="text-[16px] text-black">Will you like to create your own bucket..?</p>
